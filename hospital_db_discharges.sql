...
CREATE TABLE `discharges` (
  ...
  CONSTRAINT `discharges_ibfk_1` FOREIGN KEY (`admission_id`) REFERENCES `admissions` (`admission_id`),
  CONSTRAINT `discharges_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`)
